            ...
            <div class="row">
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box" style="background-color: #8292D9">
                        <div class="inner">
                            <h3 class="counter" style="color: white">{{ $totalDosen }}</h3>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box" style="background-color: #9BD6E2">
                        <div class="inner">
                            <h3 class="counter" style="color: white">{{ $totalMhs }}
                                <!-- <sup style="font-size: 20px">%</sup> -->
                            </h3>

                            <p style="color: white">MAHASISWA</p>
                        </div>
                        <div class="icon">
                            <i class="ion ion-android-people" style="color: white"></i>
                        </div>
                        <!-- <a href="#" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a> -->
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box" style="background-color: #ECC10C">
                        <div class="inner">
                            <h3 class="counter" style="color: white">{{ $lulusan }}</h3>

                            <p style="color: white">LULUSAN {{ date('Y') }}</p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-6">
                    <!-- small box -->
                    <div class="small-box" style="background-color: #E37763">
                        <div class="inner">
                            <h3 class="counter" style="color: white">{{ $peminat }}</h3>

                            <p style="color: white">PEMINAT {{ date('Y') - 1 }}</p>
                        </div>
                        <div class="icon">
