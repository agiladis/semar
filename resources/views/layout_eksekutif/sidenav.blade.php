...
<aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-light sidenav-active-square">
    <div class="brand-sidebar">
        <h1 class="logo-wrapper"><a class="brand-logo darken-1" href="index.html"><img class="hide-on-med-and-down" src="{{asset('assets')}}/img/logo-upn.png" alt="materialize logo" /><img class="show-on-medium-and-down hide-on-med-and-up" src="{{asset('assets')}}/img/logo-upn.png" alt="materialize logo" /><span class="logo-text hide-on-med-and-down">UPNVYK</span></a><a class="navbar-toggler" href="#"><i class="material-icons">radio_button_checked</i></a></h1>
    </div>
    <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out" data-menu="menu-navigation" data-collapsible="menu-accordion">
        <li class="active"><a class="active" href="/dashboard"><i class="material-icons">settings_input_svideo</i><span data-i18n="Modern">Dashboard</span></a>
        <li><a href="#"><i class="material-icons">dvr</i><span data-i18n="Modern">Akademik</span></a>
        </li>
        <li><a href="#"><i class="material-icons">chrome_reader_mode</i><span data-i18n="Modern">Rekapitulasi</span></a>
        <li><a href="/dashboard/keuangan"><i class="material-icons">attach_money</i><span data-i18n="Modern">Keuangan</span></a>
        <li><a href="/dashboard/mahasiswa"><i class="material-icons">group</i><span data-i18n="Modern">Kemahasiswaan</span></a>
        <li><a href="#"><i class="material-icons">school</i><span data-i18n="Modern">Penelitian Pengabdian</span></a>
        <li><a href="#"><i class="material-icons">check</i><span data-i18n="Modern">IKU</span></a>
        <li><a href="/dashboard/kepeg"><i class="material-icons">assignment_ind</i><span data-i18n="Modern">Kepegawaian</span></a>
        <li><a href="#"><i class="material-icons">device_hub</i><span data-i18n="Modern">Fungsional</span></a>
        </li>
        ...
        <!-- <li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)"><i class="material-icons">people</i><span class="menu-title" data-i18n="Dashboard">Kepegawaian</span></a>
            <div class="collapsible-body">
                <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                    <li class="active"><a href="dashboard-modern.html"><i class="material-icons">radio_button_unchecked</i><span data-i18n="Modern">Dosen</span></a>
                    </li>
                    <li><a href="dashboard-ecommerce.html"><i class="material-icons">radio_button_unchecked</i><span data-i18n="eCommerce">Tendik</span></a>
                    </li>
                </ul>
            </div>
        </li> -->
